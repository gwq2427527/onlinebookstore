...
<body scroll="no">
	<div id="layout">
		<div id="header">
			<div class="headerNav">
				...
				${appTitle }</span>
				<ul class="nav">
					<li  >${SESSION_BEAN.user.user.userName} | <a href="${ctx }/com/logout.action">Logout</a></li>
				</ul>
		...
		<div id="leftside">
			...
			<div id="sidebar">
				<div class="toggleCollapse"><h2>Menu</h2><div>收缩</div></div>
				<div class="accordion" fillSpace="sidebar">
						 <c:if test="${SESSION_BEAN.role=='SysUser' }">
							<div class="accordionHeader">
								<h2><span>Folder</span>System</h2>
							</div>
							<div class="accordionContent">
								<ul class="tree treeFolder">
									 <li><a href="${ctx}/sys/querySimpleUser.action" target="navTab" rel="mainquery">Users</a></li>
									 <li><a href="${ctx}/sys/queryBookType.action" target="navTab" rel="mainquery">Book Type</a></li>
								</ul>
							</div>
						</c:if>
						 <c:if test="${SESSION_BEAN.role=='SimpleUser' }">
						 <c:if test="${SESSION_BEAN.user.type=='Seller' }">
							<div class="accordionHeader">
								<h2><span>Folder</span>System</h2>
							</div>
							<div class="accordionContent">
								<ul class="tree treeFolder">
									 <li><a href="${ctx}/sys/queryBook.action" target="navTab" rel="mainquery">Books</a></li>
									 <li><a href="${ctx}/sys/queryUserOrder.action" target="navTab" rel="mainquery">Orders</a></li>
								</ul>
							</div>
						</c:if>
						 <c:if test="${SESSION_BEAN.user.type=='Buyer' }">
							<div class="accordionHeader">
								<h2><span>Folder</span>System</h2>
							</div>
							<div class="accordionContent">
								<ul class="tree treeFolder">
									 <li><a href="${ctx}/sys/queryMyOrder.action" target="navTab" rel="mainquery">Orders</a></li>
								</ul>
							</div>
						</c:if>
						</c:if>
						<div class="accordionHeader">
								<h2><span>Folder</span>Personal</h2>
							</div>
						<div class="accordionContent">
							<ul class="tree treeFolder">
								 <li><a href="${ctx}/com/toSelf.action" target="navTab" rel="mainquery">Information</a></li>
							</ul>
						</div>
				...
				<div class="navTab-panel tabsPageContent layoutBox">
					<div class="page unitBox">
						<div class="pageFormContent" layoutH="80" style="margin-right:230px">
							<p style="color:red">Welcome: ${SESSION_BEAN.user.user.uname}&nbsp;&nbsp;&nbsp;
							</p>
							<p style="color:red"> </p>
	...
	<div id="footer">Copyright &copy; 2016  ${appTitle }</div>
</body>
</html>